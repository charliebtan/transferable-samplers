...
if __name__ == "__main__":
    ...
    from embed import AtomConditionalEmbedder, ResidueConditionalEmbedder, SinusoidalEmbedding
else:
...
class MetaBlock(torch.nn.Module):
    ...
    def __init__(
        ...
        if pos_embed_type == "learned":
            ...
            self.pos_embed = SinusoidalEmbedding(embed_size=channels, max_len=MAX_SEQ_LEN, div_value=0.0)(
