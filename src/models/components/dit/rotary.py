...
class ApplyRotaryEmbQKV_(torch.autograd.Function):
    ...
    @staticmethod
    def vmap(args: list[Any], batch_size: int, _vmap_id: int = 0) -> tuple[torch.nn.Module, list[str]]:
    ...
    @staticmethod
    def adjoint(args: list[Any], tangents: list[Tensor], _vmap_id: int = 0) -> tuple[Optional[Tensor], ...]:
        qkv, cos, sin = args[:3]
