#!/bin/bash
python src/train.py -m launcher=mila_l40_main \
experiment=evaluation/tarflow_up_to_4aa_mala \
trainer=gpu \
tags=[sampling,eval_tarflow_up_to_4aa,smc,mala,dev] \
data.train_lmdb_prefix="train_medium_v2" \
