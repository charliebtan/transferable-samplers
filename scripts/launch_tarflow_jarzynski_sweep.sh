#!/bin/bash
python src/train.py -m launcher=mila_a100l_short \
...
model.jarzynski_sampler.langevin_eps=2e-7,5e-7,1e-6,2e-6,5e-6,1e-5,2e-5,5e-5 \
model.jarzynski_sampler.ess_threshold=0.95,0.9,0.8,0.6 \ 
